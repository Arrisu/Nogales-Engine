...
; ---------------------------------------------------------------------------
; Updates camera-A X and Y and sets flags for block redraw
; ---------------------------------------------------------------------------
...
.NoRight:
	move.w	previousAPosX,d1
	move.w	cameraAPosX.w,d2
	move.w	d2,d0
	sub.w	d1,d0
	asl.w	#8,d0
	move.w	d0,camADiffX.w
	move.w  d2,previousAPosX

	move.w  cameraAPosX.w,d3
	andi.w  #16,d3
	move.b  cameraAblkX.w,d4
	eor.b   d4,d3
	bne.s   .XNotMet
